    ...
    inner class CityViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            txtCityName.setOnClickListener {
                Toast.makeText(it.context, "${cities[adapterPosition].title}", Toast.LENGTH_LONG).show()
            }

            txtCityPopulation.setOnClickListener {
                Toast.makeText(it.context, "${cities[adapterPosition].title} ${cities[adapterPosition].population}", Toast.LENGTH_LONG).show()
            }

            imgCity.setOnClickListener {
                Toast.makeText(it.context, "${cities[adapterPosition].title} image", Toast.LENGTH_LONG).show()
            }
